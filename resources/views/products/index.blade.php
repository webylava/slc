<x-app-layout>
	@section('breadcrumb') 
		@parent
		<li>
		<a href="javascript:void();" class="text-gray-500" aria-current="page">{{ __('Products') }}</a>
		</li>
	@endsection 
					...
					<div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
						...
						<a href="{{ url('products/create') }}">
							<div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
								...
								<div>
									<p class="text-sm font-medium text-gray-600 font-bold dark:text-gray-400"> {{ __('Add Product') }} </p>
								</div>
							</div>
						</a>
						<!-- Card -->
						<a href="{{ url('products/all') }}">
							<div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
								...
								<div>
									<p class="text-sm font-medium text-gray-600 font-bold dark:text-gray-400">{{ __('List Product') }}</p>
								</div>
							</div>
						</a>
					</div>					
